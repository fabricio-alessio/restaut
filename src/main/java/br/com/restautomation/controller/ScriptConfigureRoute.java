...
public class ScriptConfigureRoute extends LoggedRoute {

	private final ScriptService scriptService;

	private final ControllerAdapter adapter = new ControllerAdapter();

	public ScriptConfigureRoute(MongoDatabase db) throws IOException {
		super("/scripts/configure/:id", "script_edit.ftl", db);
